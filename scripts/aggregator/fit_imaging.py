...
print("Test 1: fit_imaging_randomly_drawn_via_pdf_gen_from ... ", end="")
...
print("Test 2: fit_imaging_all_above_weight_gen ... ", end="")
...
print("Test 3: fit_imaging_adapt_images ... ", end="")
