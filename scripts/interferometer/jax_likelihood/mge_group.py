...
assert (
    mass_indices
), "interferometer/mge_group: no mass parameters found for sensitivity check"
...
np.testing.assert_allclose(
    ...
    -3154.194645,
    rtol=1e-4,
    err_msg="interferometer/mge_group: TransformerNUFFT vmap likelihood disagrees with TransformerDFT",
)
