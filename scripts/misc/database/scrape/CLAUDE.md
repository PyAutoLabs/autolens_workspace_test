# misc/database/scrape/ — Integration Test Coverage
...
```bash
NUMBA_CACHE_DIR=/tmp/numba_cache MPLCONFIGDIR=/tmp/matplotlib python scripts/misc/database/scrape/general.py
```
