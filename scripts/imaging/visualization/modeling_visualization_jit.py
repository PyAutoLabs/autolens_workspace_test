...
# Quick updates write the normal fit subplot (fit.png) to that image folder —
# the same file full visualization writes. Quick updates run on the main
# thread by default, so the KeyError regression this script guards would
# crash the search rather than be swallowed.
